      ...
      <div className="container">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="flex flex-col items-center justify-start">
            <i className="bx bxs-megaphone text-7xl opacity-70 mb-4"></i>
            <p className="px-8 py-4 text-center lg:w-80">
              Send shout to emergency contact with a push of one button
            </p>
          </div>
          <div className="flex flex-col items-center justify-start">
            <i className="bx bx-current-location text-7xl opacity-70 mb-4"></i>
            <p className="px-8 py-4 text-center lg:w-80">
          ...
          <div className="flex flex-col items-center justify-start">
            <i className="bx bxs-layer text-7xl opacity-70 mb-4"></i>
            <p className="px-8 py-4 text-center lg:w-80">
